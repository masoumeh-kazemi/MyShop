...
namespace Shop.RazorPage.Pages.Checkout
{
    public class IndexModel : BaseRazorPage
    {
        ...
        public IndexModel(IOrderFacade orderFacade, IUserAddressFacade userAddressFacade, IShippingMethodFacade shippingMethodFacade, IZibalService zibalService)
        {
        ...
        public async Task<IActionResult> OnGet()
        {
            ...
            var shippingMethods = await _shippingMethodFacade.GetList();
        ...
        public async Task<IActionResult> OnPost(long shippingMethodId, long orderId, string errorRedirect="", string successRedirect="")
        {
            ...
            //{
                ...
                var result = await _zibalService.StartPay(new ZibalPaymentRequest()
                {
                    ...
                    CallBackUrl = $"{url}/checkout?orderId={order.Id}&&errorRedirect={errorCallBackUrl2}&&successRedirect={successCallBackUrl2}&&shippingMethodId={shippingMethodId}",
        ...
        public async Task<IActionResult> OnGetVerify(long orderId, long trackId, int success, string errorRedirect, string successRedirect)
        {
            if (success == 0)
